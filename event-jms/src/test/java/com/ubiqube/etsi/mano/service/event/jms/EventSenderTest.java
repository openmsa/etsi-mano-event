...
class EventSenderTest {
	@Mock
	private NotificationController actionController;

	@Test
	void test() {
		final EventSender srv = new EventSender(actionController);
		final SubscriptionEvent ev = new SubscriptionEvent();
		srv.onNotificationSender(ev);
		assertTrue(true);
	}
